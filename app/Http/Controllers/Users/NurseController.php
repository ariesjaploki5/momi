...
class NurseController extends Controller
{
    ...
    {
        // return User::whereType('nurse')->latest()->paginate(1);
        $users = User::whereType('nurse')->paginate(10)->jsonSerialize();
    ...
    {
        $users = User::onlyTrashed()->whereType('nurse')->paginate(10)->jsonSerialize();
