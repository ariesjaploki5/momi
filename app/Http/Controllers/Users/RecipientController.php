...
class RecipientController extends Controller
{
    ...
    {
        // return User::whereType('recipient')->latest()->paginate(1);
        $users = User::whereType('recipient')->paginate(10)->jsonSerialize();
    ...
    {
        $users = User::onlyTrashed()->whereType('recipient')->paginate(10)->jsonSerialize();
