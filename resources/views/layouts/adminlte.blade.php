    ...
    <!-- Main Sidebar Container -->
        <aside class="main-sidebar sidebar-light-primary elevation-5" id="main-sidebar">
            ...
            <nav class="mt-2">
                ...
                @if(Auth::user()->type === 'doctor' || Auth::user()->type === 'nurse')
                <li class="nav-item">
               ...
               @endif
                ...
                @if(Auth::user()->type === 'nurse' || Auth::user()->type === 'doctor')
                <li class="nav-item has-treeview">
                    <a href=" #" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../notclaimedmilk" class="nav-link">
                                <i class="nav-icon fas fa-scroll green"></i>
                                <p>Not Claimed Milk</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../expiredmilk" class="nav-link">
                                <i class="nav-icon fas fa-scroll green"></i>
                                <p>Expired Milk</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../donatedmilk" class="nav-link">
                                <i class="nav-icon fas fa-scroll green"></i>
                                <p>Donated Milk</p>
                            </a>
                        </li>
