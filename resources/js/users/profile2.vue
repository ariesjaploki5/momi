            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form class="text-capitalize" @submit.prevent="updateProfile()">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label" for="address">password</label>
                            <div class="col-sm-9">
                                <input type="date" id="address" v-model="form.password" name="address" class="form-control form-control-sm" :placeholder="optional">
                            </div>
                        </div>
